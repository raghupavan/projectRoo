...
public class Pro extends navigation {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("Oncreate", "Pro.java");
        x();
    }

    public void post(View view) {
        Intent i = new Intent(this, SellHere.class);
        startActivity(i);
    }
    ...
    public void x() {
        ...
        new Pro.MongoAsyncTaskQues().execute();
        try {
            Thread.sleep(500);
...
//                R.layout.activity_ser,jsonObject.toString() );
        ...
        Freqquest1 l = new Freqquest1(this, jsonArray);
        l.pro = this;
    ...
    {
        Intent i= new Intent(this,ProDisp.class);
        try {
    ...
    class MongoAsyncTaskQues extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... args0) {
            try {
                try {
                    URL url1 = new URL("https://api.mongolab.com/api/1/databases/asedb/collections/product?apiKey=jhntLv8SVVc_a9DFCCw6s9S_OPSEl-ia");
...
class Freqquest1 extends BaseAdapter {
    ...
    public Freqquest1(Context context, JSONArray data) {
